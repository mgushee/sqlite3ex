...
##--------------------------------------------------------------------
  ...
  defp col_type_to_string(:real), do: "REAL"
  defp col_type_to_string(:blob), do: "BLOB"
  defp col_type_to_string(atom) when is_atom(atom) do
    String.upcase(Atom.to_string atom)
  end
  defp col_type_to_string(string) when is_bitstring(string), do: string
...
##--------------------------------------------------------------------
  ...
  def col_type_to_atom("BLOB"), do: :blob
  def col_type_to_atom(string), do: String.to_atom(String.downcase string)
